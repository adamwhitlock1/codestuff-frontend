  ...
  <div>
    <Layout>
      <div class="block md:flex items-center flex-row py-6 mt-6 md:px-12">
        ...
        <div
          class="text-white text-center p-6 md:pr-16 bg-white rounded md:w-1/3"
        >
          <h4 class="text-4xl text-magenta m-0 mb-3">
            Betapic: unified search for creative commons images.
          </h4>
          <p
            class="font-extrabold mx-12 my-0 text-magenta-darker rounded px-10 py-4 bg-white shadow"
          >
        ...
        <div class="hidden md:block md:w-2/3 px-2 md:pr-4">
          <g-image src="@/assets/images/betapic-screens-white.jpg" alt="" />
        </div>
      </div>
    </Layout>
  </div>
